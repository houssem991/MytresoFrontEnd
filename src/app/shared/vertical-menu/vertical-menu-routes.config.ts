...
export const ROUTES: RouteInfo[] = [
  ...
  { path: '/pages/agents-list', title: 'gestion des Agents', icon: 'ft-user', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
  { path: '/pages/agents-role', title: 'gestion des roles', icon: 'ft-lock', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
